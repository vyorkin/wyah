...
dev: all
	ghcid --restart=src/Wyah/Chapter5/Calc/Lexer.x --restart=src/Wyah/Chapter5/Calc/Parser.y  --command="cabal new-repl $(GHC_OPTIONS)" | source-highlight -s haskell -f esc
repl:
